...
std::string* commandLineLoader(int argc, char **argv){
	...
	std::string * shaderNames = new std::string[3];
	shaderNames[0] = "Invalid";
	shaderNames[1] = "Invalid";
	shaderNames[2] = "Invalid";
	...
	if(shaderNames[2] == "Invalid"){
		std::cout << "Missing -m model flag, default cube will be loaded instead!" << std::endl;
	}
